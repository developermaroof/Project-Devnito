...
const Projects = () => {
  return (
    <div className="bg-gray-100">
      <ProjectSlider>
        <div className="gap-8 bg-blue-300 flex flex-col p-4 md:flex-row md:justify-center md:items-center">
          <div className="py-4 ">
            <img
          ...
          <div>
            ...
            <p className="py-4 text-sm">
              We led MenaJobs.io's development, shaping it into a user-friendly
              job portal. My work spanned planning, design, coding, and
              optimization—the result: a trusted platform connecting job seekers
              and employers in the MENA region. Mobile-friendly, secure, and
              performance-driven, it's now a go-to resource for career growth.
            </p>
        ...
        <div className="gap-8 bg-gray-300 flex flex-col p-4 md:flex-row md:justify-center md:items-center">
          <div className="py-6">
            <img
          ...
          <div>
            ...
            <p className="py-6 text-sm">
              ...
              for discovering and exploring apps and games from the Play Store.
              My work spans design, search enhancements, mobile responsiveness,
              and security measures. APK-Hub is now a trusted resource,
              attracting a growing user base and delivering a top-tier user
              experience.
            </p>
            <h6 className="text-sm font-semibold">Challenges Faced</h6>
            <ul className="px-4 text-xs list-disc my-2">
        ...
        <div className="gap-8 bg-blue-100 flex flex-col p-4  md:flex-row md:justify-center md:items-center">
          <div className="py-4">
            <img
          ...
          <div>
            ...
            <p className="py-4 text-sm">
              ...
              user-friendly platform for generating and customizing reports. My
              work spans design, data integration, security, and feedback
